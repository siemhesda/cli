...
define('package-type', {
  ...
  description: `
    The package type to associate with the root package when generating SBOMs.
    For SPDX, this is the value for the \`primaryPackagePurpose\` fieled. For
    CycloneDX, this is the value for the \`type\` field.
  `,
  flatten,
})
